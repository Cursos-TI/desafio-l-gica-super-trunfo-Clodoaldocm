...
int main()
{
	...
	double superPoder1, superPoder2, soma1, soma2;
...
//======= COMPARAÇÃO ============================
	...
	printf("Primeira Escolha do que deve ser comparado\n");
	printf("1 - Populacao\n");
	printf("2 - Area\n");
	printf("3 - PIB\n");
	printf("4 - Densidade\n");
	...
	//verifica escolha e se não for correta sai do programa
	if(escolha < 1 || escolha > 5){
		printf("Tente novamente e escolha um número entre 1 e 5\n");
		return 0;
	}
	printf("Segunda Escolha do que deve ser comparado\n");
	escolha != 1 ? printf("1 - Populacao\n") : printf("");
	escolha != 2 ? printf("2 - Area\n") : printf("");
	escolha != 3 ? printf("3 - PIB\n") : printf("");
	escolha != 4 ? printf("4 - Densidade\n") : printf("");
	escolha != 5 ? printf("5 - PIB per Capita\n"):printf("");
	printf("Escolha 2:");
	scanf("%d",&escolha2);
	//Verifica se a escolha está entre 1 e 5 e se não foi escolhido o mesmo número anterior
	if(escolha2 < 1 || escolha2 > 5 || escolha==escolha2){
		printf("Tente novamente e escolha um número válido\n");
		return 0;
	}

	//print nome da cidade de cada carta
	printf("Carta 1 - Cidade: %s\n", nomeCidade1);
	printf("Carta 2 - Cidade: %s\n", nomeCidade2);

	//testa primeira escolha
	switch(escolha){
	case 1: 
		soma1 = (double) nPopulacao1;
	       	soma2 = (double) nPopulacao2;
		printf("Carta 1 - Populacao: %d\n", nPopulacao1);
	...
	case 2:
		soma1 = (double) area1;
		soma2 = (double) area2;
		printf("Carta 1 - Area: %f\n", area1);
		printf("Carta 2 - Area: %f\n", area2);
		if(area1 == area2){
			printf("### EMPATE! ###\n");
		}else if(area1 > area2){
			printf("### Carta 1 venceu! ###\n");
	...
	case 3:
		...
		break;
	case 4:
		soma1 = (double) densidPop1;
		soma2 = (double) densidPop2;
	...
	case 5:
		soma1 = (double) pibPcapta1;
		soma2 = (double) pibPcapta2;
